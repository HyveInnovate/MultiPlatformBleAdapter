Pod::Spec.new do |spec|
  spec.name         = "HyveMultiplatformBleAdapter"
  spec.version      = "0.1.9"
  ...
  spec.homepage     = "https://github.com/HyveInnovate/MultiPlatformBleAdapter"
  ...
  spec.source       = { :git => "https://github.com/HyveInnovate/MultiPlatformBleAdapter.git", :tag => "#{spec.version}" }
